<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RaporSonuc.aspx.cs" Inherits="RaporSonuc" %>
...
<body style="background:#fff !important; ">
     <div class="ortalarapor">
           <div class="raporAlani">
        <div class="raporsolalanim fl">
            <div class="raporlogoalani fl"><img src="Tema/img/logo.jpg" /></div>
            <div class="raporsagalanlari fr">
			<br/> 
            <asp:Label ID="lblIslemTipi" runat="server" Text=""></asp:Label>
            <label>Libre le :</label> <asp:Label ID="lblUygunlukTarihi" runat="server" Text="—-"></asp:Label><br />
